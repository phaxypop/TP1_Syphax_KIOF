...
////////////////////////////////////////////////////////////////////
const videos = ["IajeQM00yfE", "52IyDIMyejQ", "yXRlrix-pPk", "mIfpVrYIhvM"];
...
function showMember(member, event) {
  document.getElementById("member-name").textContent = members[member].name;
  document.getElementById("member-birthday").textContent =
    members[member].birthday;
  document.getElementById("member-role").textContent = members[member].role;
  document.getElementById("member-nationality").textContent =
    members[member].nationality;
  document.getElementById("member-fact").textContent = members[member].fact;
